...
public class StackyGUIScreen extends AbstractContainerScreen<StackyGUIMenu> {
    ...
    public void init() {
        super.init();
        int buttonWidth = 100, buttonHeight = 20, buttonSpacing = 10;
        int startX = (this.width - (3 * buttonWidth + 2 * buttonSpacing)) / 2, y = 10;
    ...
    public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
        ...
        for (int i = 0; i < availableItems; i++) {
            ...
            int lineY = elementY + 96 + 10;
            guiGraphics.fill(0, lineY, this.width, lineY + 1, 0xFFFFFFFF);
        }
    }
